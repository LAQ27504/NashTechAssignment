...
public class PersonData
{
    ...
    [
        ...
        new("Albert", "Wesker", Gender.Male, new DateTime(2000, 10, 10), "012-345-6789", "Austin", false),
        new("Ada", "Wong", Gender.Female, new DateTime(1990, 11, 11), "123-987-6543", "San Francisco", true),
        new("Carlos", "Oliveira", Gender.Male, new DateTime(2003, 12, 12), "234-876-5432", "Seattle", false),
        new("Barry", "Burton", Gender.Male, new DateTime(2004, 5, 20), "345-765-4321", "Boston", true),
        new("Hunk", "Unknown", Gender.Male, new DateTime(1982, 6, 15), "456-654-3210", "Miami", false),
        new("Sheva", "Alomar", Gender.Female, new DateTime(2005, 7, 25), "567-543-2109", "Denver", true),
        ...
        new("Billy", "Coen", Gender.Male, new DateTime(2001, 10, 5), "890-210-9876", "Las Vegas", true),
